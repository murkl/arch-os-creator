...
ARCH_ISO_DOWNLOAD_URL="https://mirrors.xtom.de/archlinux/iso/latest" # TODO: select mirror

# /////////////////////////////////////////////////////
# TUI VARIABLES
# /////////////////////////////////////////////////////

TUI_TITLE="Arch OS USB Creator"
TUI_WIDTH="80"
TUI_HEIGHT="20"
...
whiptail --title "$TUI_TITLE" --msgbox "Welcome to ${TUI_TITLE}!\n\nThis script will download the latest Arch Linux ISO and will create a bootable USB Device." "$TUI_HEIGHT" "$TUI_WIDTH"
